...
"""
THIS CODE WAS RIPPED DIRECTLY FROM:
    http://scikit-learn.org/stable/_downloads/plot_cluster_comparison.py
...
for i_dataset, dataset in enumerate([noisy_circles, noisy_moons, blobs,
    ...
    for name, algorithm in algo_list:
        ...
        # plot
        plt.subplot(4, len(algo_list), plot_num)
        if i_dataset == 0:
